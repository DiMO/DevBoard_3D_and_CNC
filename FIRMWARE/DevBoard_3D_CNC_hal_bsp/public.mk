...
SOPCINFO_FILE := Z:/HDS/DimoSoft/DevBoard_3D_CNC/quartus/DevBoard_3D_DE2-70/DevBoard_3D_CNC.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DevBoard_3D_CNC
SOPC_NAME := DevBoard_3D_CNC
...
# The SOPC System ID 
# setting SOPC_SYSID is 538181633
SOPC_SYSID_FLAG += --id=538181633
ELF_PATCH_FLAG  += --id 538181633

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x6009870
SOPC_SYSID_FLAG += --sidp=0x6009870
ELF_PATCH_FLAG  += --sidp 0x6009870

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1397440941
SOPC_SYSID_FLAG += --timestamp=1397440941
ELF_PATCH_FLAG  += --timestamp 1397440941
...
# enabled. none 
# setting altera_avalon_uart_driver.enable_ioctl is true
...
ALT_CPPFLAGS += -DALTERA_AVALON_UART_USE_IOCTL
