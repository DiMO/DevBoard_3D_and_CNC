...
# Memory: onchip_mem
MEM_1 := DevBoard_3D_CNC_onchip_mem
...
$(MEM_1)_START := 0x06004000
$(MEM_1)_END := 0x06007fff
...
$(MEM_2)_HIERARCHICAL_PATH := video_mem
$(MEM_2)_WIDTH := 16
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: video_mem
video_mem: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
